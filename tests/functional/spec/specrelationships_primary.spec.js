...
describe("Relationships - Primary Person", () => {
  ...
  describe("Given I am completing the test_relationships_primary survey", () => {
    ...
    it("When I add household members, Then I will be asked my relationships as a primary person", async ()=> {
      ...
      await expect(await $(await RelationshipsPage.questionText()).getText()).to.contain("is your");
    });
    ...
    it("When I add household members, Then non-primary relationships will be asked as a non primary person", async ()=> {
      ...
      await $(await ListCollectorPage.no()).click();
      await $(await ListCollectorPage.submit()).click();
      await $(await RelationshipsPage.relationshipBrotherOrSister()).click();
      await $(await RelationshipsPage.submit()).click();
      await $(await RelationshipsPage.relationshipSonOrDaughter()).click();
      await $(await RelationshipsPage.submit()).click();
      await expect(await $(await RelationshipsPage.questionText()).getText()).to.contain("is their");
    });
    ...
    it("When I add household members And add thir relationships And remove the primary person And add a new primary person then I will be asked for the relationships again", async ()=> {
      ...
      await expect(await $(await RelationshipsPage.questionText()).getText()).to.contain("Samuel Clemens is your");
    });
