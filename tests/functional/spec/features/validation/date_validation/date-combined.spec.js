  ...
  describe("Period Validation", () => {
    describe("Given I enter dates", () => {
      it("When I enter a single dates that are too early/late, Then I should see a single validation errors", async ()=> {
        await $(await DateRangePage.dateRangeFromday()).setValue(12);
        await $(await DateRangePage.dateRangeFrommonth()).setValue(12);
        await $(await DateRangePage.dateRangeFromyear()).setValue(2016);

        await $(await DateRangePage.dateRangeToday()).setValue(22);
        await $(await DateRangePage.dateRangeTomonth()).setValue(2);
        await $(await DateRangePage.dateRangeToyear()).setValue(2017);
        await $(await DateRangePage.submit()).click();
        await expect(await $(await DateRangePage.errorNumber(1)).getText()).to.contain("Enter a date after 12 December 2016");
        await expect(await $(await DateRangePage.errorNumber(2)).getText()).to.contain("Enter a date before 22 February 2017");
      });

      it("When I enter a range too large, Then I should see a range validation error", async ()=> {
        await $(await DateRangePage.dateRangeFromday()).setValue(13);
        await $(await DateRangePage.dateRangeFrommonth()).setValue(12);
        await $(await DateRangePage.dateRangeFromyear()).setValue(2016);

        await $(await DateRangePage.dateRangeToday()).setValue(21);
        await $(await DateRangePage.dateRangeTomonth()).setValue(2);
        await $(await DateRangePage.dateRangeToyear()).setValue(2017);
        await $(await DateRangePage.submit()).click();
        await expect(await $(await DateRangePage.errorNumber(1)).getText()).to.contain("Enter a reporting period less than or equal to 50 days");
      });
      ...
      it("When I enter a range too small, Then I should see a range validation error", async ()=> {
        ...
        await $(await DateRangePage.dateRangeToday()).setValue(10);
        await $(await DateRangePage.dateRangeTomonth()).setValue(1);
        await $(await DateRangePage.dateRangeToyear()).setValue(2017);
        await $(await DateRangePage.submit()).click();
        await expect(await $(await DateRangePage.errorNumber(1)).getText()).to.contain("Enter a reporting period greater than or equal to 10 days");
      });
      ...
      it("When I enter valid dates, Then I should see the summary page", async ()=> {
        ...
        // Min range
        await $(await DateRangePage.dateRangeToday()).setValue(11);
        await $(await DateRangePage.dateRangeTomonth()).setValue(1);
        await $(await DateRangePage.dateRangeToyear()).setValue(2017);
        await $(await DateRangePage.submit()).click();
        await expect(await $(await SubmitPage.dateRangeFrom()).getText()).to.contain("1 January 2017 to 11 January 2017");

        // Max range
        await $(await SubmitPage.dateRangeFromEdit()).click();
        await $(await DateRangePage.dateRangeToday()).setValue(20);
        await $(await DateRangePage.dateRangeTomonth()).setValue(2);
        await $(await DateRangePage.dateRangeToyear()).setValue(2017);
        await $(await DateRangePage.submit()).click();
        await expect(await $(await SubmitPage.dateRangeFrom()).getText()).to.contain("1 January 2017 to 20 February 2017");
      });
    });
  });
});
