...
describe("Section Summary", () => {
  describe("Given I start a Test Section Summary survey", () => {
    ...
    it("When I edit an answer from the summary page, the Previous button url should contain an anchor referencing the answer id of the answer I am changing and when clicked, the browser url contains the same", () => {
      $(InsuranceAddressPage.submit()).click();
      $(ListedPage.submit()).click();
    ...
    it("When I edit an answer from the final summary page, the Change button url should contain return_to, return_to_answer_id query params and when clicked, the browser url contains the same", () => {
      $(InsuranceAddressPage.submit()).click();
      $(ListedPage.submit()).click();
      $(InsuranceAddressPage.submit()).click();
      $(ListedPage.submit()).click();
