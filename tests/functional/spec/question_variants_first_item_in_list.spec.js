...
const ListCollectorEditPage = require('../generated_pages/variants_first_item_in_list/list-collector-edit.page.js');
const ListCollectorRemovePage = require('../generated_pages/variants_first_item_in_list/list-collector-remove.page.js');
const ListStatusQuestion = require('../generated_pages/variants_first_item_in_list/list-status.page.js');
const SummaryPage = require('../generated_pages/variants_first_item_in_list/personal-summary.page.js');
