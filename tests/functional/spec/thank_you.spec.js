...
describe("Thank You Social", () => {
  describe("Given I launch a social themed questionnaire", () => {
    beforeEach(() => {
      browser.openQuestionnaire("test_theme_social.json", { version: "v2", theme: "social" });
    });
...
describe("Thank You Default View Response Enabled", () => {
  describe("Given I launch a questionnaire where view response is enabled", () => {
    ...
    it("When I navigate to the thank you page, and I have submitted less than 40 seconds ago, Then I should see the countdown timer and option to view my answers", () => {
