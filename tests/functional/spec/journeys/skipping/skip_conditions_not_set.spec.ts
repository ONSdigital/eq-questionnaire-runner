...
test.describe('Skip Conditions - Not Set', () => {
  test.beforeEach('Load the survey', async ({ openQuestionnaire }) => {
    await openQuestionnaire('test_skip_condition_not_set.json')
  })

  test('Given I do not complete the first page, Then I should see the summary page', async ({ page }) => {
  ...
  test('Given I complete the first page, Then I should see the drink page', async ({ page }) => {
