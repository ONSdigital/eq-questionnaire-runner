...
test.describe('Component: Mutually Exclusive Unit With Single Checkbox Override', () => {
  ...
  test.describe('Given the user has entered a value for the non-exclusive unit answer', () => {
    test('When then user clicks the mutually exclusive checkbox answer, Then only the mutually exclusive checkbox should be answered.', async ({
      page
    }) => {
  ...
  test.describe('Given the user has not clicked the mutually exclusive checkbox answer', () => {
    test('When the user enters a value for the non-exclusive unit answer, Then only the non-exclusive unit answer should be answered.', async ({
      page
    }) => {
      const summaryPage = new SummaryPage(page)
      const unitPage = new UnitPage(page)
