...
test.describe('List Collector Section Summary and Summary Items', () => {
  test.describe('Given I launch the test list collector section summary items survey', () => {
    ...
    test('When I get to the Hub, Then from there the next block in list collector content section should be list collector content page.', async ({
      page
    }) => {
    ...
    test('When I get to list collector content block section, Then I should be able to complete repeating blocks and get to the summary.', async ({
      page
    }) => {
      const hubPage = new HubPage(page)
      const listCollectorContentPage = new ListCollectorContentPage(page)
