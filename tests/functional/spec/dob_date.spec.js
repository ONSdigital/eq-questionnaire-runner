...
describe("Date of birth check", () => {
  ...
  it("Given Iam completing a date question, when I value less than 16 years, Iam routed to under 16 page", () => {
  ...
  it("Given Iam completing a date question, when I value less than 16 years, Iam routed to over 16 page", () => {
    $(DateOfBirthPage.day()).setValue(12);
    $(DateOfBirthPage.month()).setValue(4);
