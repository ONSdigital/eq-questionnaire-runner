...
exports.config = {
    ...
    // Specify Test Files
    // ==================
    // Define which test specs should run. In the current WDIO setup these patterns are
    // resolved relative to this config file, so keep them anchored to `tests/functional`.
    //
    specs: ["./spec/**/*.js"],
    suites: {
        ...
        features: [
            "./spec/features/**/*.js",
            "./spec/features/repeating_sections/**/*.js",
            "./spec/features/hub_and_spoke/**/*.js",
        ],
        migrated: [
