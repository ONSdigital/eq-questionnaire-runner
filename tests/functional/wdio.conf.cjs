exports.config = {
  ...
  //
  specs: ["./spec/features/confirmation_question.spec.js", "./spec/features/units.spec.js", "./spec/list_collector/list_collector_content.spec.js", "./spec/list_collector/list_collector_section_summary.spec.js", "./spec/list_collector/relationships.spec.js", "./spec/supplementary_data/supplementary_data_with_list_collector.spec.js"],
  suites: {
