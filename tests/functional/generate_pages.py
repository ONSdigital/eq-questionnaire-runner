...
QUESTION_DEFINITION_TITLE_GETTER = Template(
    r"""  definitionTitle(definitionIndex) { return `[data-qa='collapsible-title-${definitionIndex}}']`; }

"""
)

QUESTION_DEFINITION_CONTENT_GETTER = Template(
    r"""  definitionContent(definitionIndex) { return `[data-qa='collapsible-content-${definitionIndex}}']`; }

"""
)

QUESTION_DEFINITION_BUTTON_GETTER = Template(
    r"""  definitionButton(definitionIndex) { return `[data-qa='collapsible-close-button-${definitionIndex}}']`; }
...
LIST_SUMMARY_EDIT_LINK_GETTER = r"""  listEditLink(instance) { return `[data-qa='change-item-link-${instance}']`; }

"""

LIST_SUMMARY_REMOVE_LINK_GETTER = r"""  listRemoveLink(instance) { return `[data-qa='remove-item-link-${instance}']`; }
...
LIST_SECTION_SUMMARY_LABEL_GETTER = Template(
    r"""  ${list_name}ListLabel(listItemInstance) { return `div[data-qa="${list_name}-list-summary"] td[data-qa="list-item-label-` + listItemInstance + `"]`; }
...
LIST_SECTION_SUMMARY_EDIT_LINK_GETTER = Template(
    r"""  ${list_name}ListEditLink(listItemInstance) { return `div[data-qa="${list_name}-list-summary"] a[data-qa="change-item-link-` + listItemInstance + `"]`; }

"""
)

LIST_SECTION_SUMMARY_REMOVE_LINK_GETTER = Template(
    r"""  ${list_name}ListRemoveLink(listItemInstance) { return `div[data-qa="${list_name}-list-summary"] a[data-qa="remove-item-link-` + listItemInstance + `"]`; }
