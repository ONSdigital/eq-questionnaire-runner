...
class TestFeedback(IntegrationTestCase):
    ...
    def test_feedback_type_missing(self):
        ...
        self.assertEqualPageTitle("Error: Feedback - Test Feedback")
    ...
    def test_feedback_call_to_action_shown(self):
        ...
        self.assertInSelectorCSS(
            "/submitted/feedback/send", class_="ons-feedback__link"
        )
    ...
    def test_feedback_upload_failed(self):
        ...
        self.assertEqualPageTitle("Sorry, there is a problem - Test Feedback")
