...
class TestQuestionnaireQuestionDefinition(IntegrationTestCase):
    def test_question_definition(self):
        ...
        self.launchSurveyV2(schema_name="test_question_definition_array_type")

        # When I start the survey I am presented with the definitions title and content correctly
        self.assertInBody(
            "Do you connect a LiFePO4 battery to your <strong>photovoltaic system</strong> to store surplus energy?"
        )
