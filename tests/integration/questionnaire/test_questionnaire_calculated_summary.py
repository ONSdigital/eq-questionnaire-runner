...
class TestQuestionnaireCalculatedSummary(QuestionnaireTestCase):
    ...
    def test_calculated_summary_total_playback(self):
        ...
        self.post()
        self.assertInBody(
            'Total currency values: <strong class="ons-highlight">£80.00</strong>'
        )
    ...
    def test_calculated_summary_default_decimal_places(self):
        ...
        self.post()
        self.assertInBody(
            'Total currency values: <strong class="ons-highlight">£120.00</strong>'
        )
    ...
    def test_calculated_summary_with_varying_decimal_places(self):
        ...
        self.post()
        self.assertInBody(
            'Total currency values: <strong class="ons-highlight">£120.58985</strong>'
        )
