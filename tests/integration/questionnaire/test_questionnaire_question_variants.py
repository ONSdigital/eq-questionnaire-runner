...
class TestQuestionnaireQuestionVariants(IntegrationTestCase):
    ...
    def test_non_proxy_answer_shows_non_proxy_title(self):
        self.launchSurveyV2(schema_name="test_variants_question")
    ...
    def complete_first_section(self, proxy=False):
        ...
        self.assertInBody("Are you <strong>Linus Torvalds</strong>?")
        ...
        expected_question = (
            "What age is <strong>Linus Torvalds</strong>?"
            if proxy
        ...
        expected_question = (
            "<strong>Linus Torvalds</strong> is over 16?"
            if proxy
