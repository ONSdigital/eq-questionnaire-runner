...
def test_context_includes_period_str_if_available(fake_session_data, app: Flask):
...
def test_context_includes_ru_name_if_available(fake_session_data, app: Flask):
    with app.app_context():
