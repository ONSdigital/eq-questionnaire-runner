...
TEST_FORMAT_UNIT_PARAMS = (
    ...
    [
        ...
        (Decimal("0.123"), "millimeter", "en_GB", "short", "0.123 mm"),
        (123, "centimeter", "en_GB", "short", "123 cm"),
        (100, "length-meter", "en_GB", "short", "100 m"),
        (100, "length-centimeter", "en_GB", "short", "100 cm"),
        (100, "area-square-meter", "en_GB", "short", "100 m²"),
        (100, "area-square-centimeter", "en_GB", "short", "100 cm²"),
        (100, "area-square-kilometer", "en_GB", "short", "100 km²"),
        (100, "area-square-mile", "en_GB", "short", "100 sq mi"),
        (100, "area-hectare", "en_GB", "short", "100 ha"),
        (100, "area-acre", "en_GB", "short", "100 ac"),
        (100, "volume-cubic-meter", "en_GB", "short", "100 m³"),
        (100, "volume-cubic-centimeter", "en_GB", "short", "100 cm³"),
        (100, "volume-liter", "en_GB", "short", "100 l"),
        (100, "volume-hectoliter", "en_GB", "short", "100 hl"),
        (100, "volume-megaliter", "en_GB", "short", "100 Ml"),
        (100, "duration-hour", "en_GB", "short", "100 hrs"),
        (100, "duration-hour", "en_GB", "long", "100 hours"),
        (100, "duration-year", "en_GB", "long", "100 years"),
        (100, "mass-tonne", "en_GB", "long", "100 tonnes"),
        (1, "mass-tonne", "en_GB", "long", "1 tonne"),
        (100, "mass-tonne", "en_GB", "short", "100 t"),
    ],
)
...
def test_format_number(mocker, value, locale_string, expected_result, app):
    with app.app_context():
        mocker.patch(
            "app.jinja_filters.flask_babel.get_locale",
            mocker.Mock(return_value=locale_string),
...
def test_format_unit(
    ...
    assert format_unit(measurement_unit, value, length=length) == expected_result
