...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("volume-cubic-centimetre", 100, "short", "100 cm³", "en_GB"),
...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("volume-cubic-centimetre", "short", "cm³", "en_GB"),
        ...
        ("volume-cubic-centimetre", "long", "cubic centimetres", "en_GB"),
