...
def test_decrypt_supplementary_data_raises_validation_error_when_encrypted_payload_missing_keys(
    app: Flask, mock_data
):
    with app.app_context():
        with pytest.raises(ValidationError) as e:
            decrypt_supplementary_data(mock_data)
