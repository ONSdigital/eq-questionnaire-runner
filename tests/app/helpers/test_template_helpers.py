...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            [
                "ONS Surveys",
                read_file("./templates/assets/images/beisni-logo.svg"),
                None,
            ],
        ),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (SurveyType.BEISNI, "en", BEISNIBusinessSurveyConfig),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (SurveyType.BEISNI, "en", "ONS Surveys"),
