...
def test_removing_list_item_data(
    ...
    assert questionnaire_store_with_supplementary_data.list_store["products"].items == [
        "item-1"
    ]
    ...
    # :TODO: the list collector with repeating blocks doesn't revert to incomplete but should, add it to the assertion on fix
