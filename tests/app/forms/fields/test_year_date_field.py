...
def test_generate_year_date_form_creates_empty_form():
    form_class = year_date_field.get_form_class([OptionalForm()])
...
def test_year_date_form_empty_data():
    form = year_date_field.get_form_class([OptionalForm()])
...
def test_year_date_form_format_data():
    ...
    class TestForm(Form):
        field = year_date_field.YearDateField(validators=[OptionalForm()])
