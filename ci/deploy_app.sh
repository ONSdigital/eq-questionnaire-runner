...
SUBMITTED_RESPONSE_EXPIRATION_IN_SECONDS="${SUBMITTED_RESPONSE_EXPIRATION_IN_SECONDS:=2700}"
...
gcloud beta run deploy eq-questionnaire-runner \
    ...
    --set-env-vars SUBMITTED_RESPONSE_EXPIRATION_IN_SECONDS="${SUBMITTED_RESPONSE_EXPIRATION_IN_SECONDS}" \
