...
SUBMISSION_BUCKET_NAME="${PROJECT_ID}-submission"
FEEDBACK_BUCKET_NAME="${PROJECT_ID}-feedback"
...
gcloud beta run deploy eq-questionnaire-runner \
    ...
    --set-env-vars SUBMISSION_BUCKET_NAME="${SUBMISSION_BUCKET_NAME}" \
    --set-env-vars FEEDBACK_BUCKET_NAME="${FEEDBACK_BUCKET_NAME}" \
