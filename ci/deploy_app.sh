...
gcloud beta run deploy eq-questionnaire-runner \
    ...
    --set-env-vars WEB_SERVER_WORKERS="7" \
    --set-env-vars WEB_SERVER_THREADS="10" \
    --set-env-vars WEB_SERVER_UWSGI_ASYNC_CORES="10" \
    ...
    --set-env-vars COOKIE_SETTINGS_URL="#" \
    --set-env-vars CDN_URL="https://cdn.census.gov.uk" \
    --set-env-vars CDN_ASSETS_PATH="/design-system" \
    --set-env-vars ADDRESS_LOOKUP_API_URL="#" \
    --set-env-vars ADDRESS_LOOKUP_API_AUTH_ENABLED="False" \
    --set-env-vars ADDRESS_LOOKUP_API_AUTH_TOKEN_LEEWAY_IN_SECONDS="10" \
    --set-env-vars EQ_NEW_RELIC_ENABLED="False" \
    --set-env-vars NEW_RELIC_LICENSE_KEY="" \
    --set-env-vars NEW_RELIC_APP_NAME="" \
