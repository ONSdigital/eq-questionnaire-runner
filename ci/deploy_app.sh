...
EQ_SUBMISSION_BUCKET_NAME="${PROJECT_ID}-submission"
EQ_FEEDBACK_BUCKET_NAME="${PROJECT_ID}-feedback"
...
gcloud beta run deploy eq-questionnaire-runner \
    ...
    --set-env-vars EQ_SUBMISSION_BUCKET_NAME="${EQ_SUBMISSION_BUCKET_NAME}" \
    --set-env-vars EQ_FEEDBACK_BUCKET_NAME="${EQ_FEEDBACK_BUCKET_NAME}" \
