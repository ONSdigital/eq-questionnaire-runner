...
class SessionStore:
    def __init__(self, user_ik: str, pepper: str, eq_session_id: str = None) -> None:
    ...
    def _load(self) -> Optional[EQSession]:
        ...
        self._eq_session = current_app.eq["storage"].get(EQSession, self.eq_session_id)  # type: ignore
