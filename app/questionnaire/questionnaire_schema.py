...
class QuestionnaireSchema:  # pylint: disable=too-many-public-methods
    ...
    @cached_property
    def min_and_max_map(self) -> ImmutableDict[str, int | str | dict[str, str | int]]:
    ...
    def _create_min_max_map(
            ...
            if isinstance(value, int):
                ...
                if value.get("source") == "answers":
                    if (
                        ...
                        longest_string = int(self._min_and_max_map[value["identifier"]][
                            min_max
                        ])
                    if not longest_string:
                        longest_string = int(self._min_and_max_map[value["identifier"]][
        ...
        if longest_string:
            ...
            self._min_and_max_map[answer_id][min_max] = len(default_min_max)  # type: ignore
