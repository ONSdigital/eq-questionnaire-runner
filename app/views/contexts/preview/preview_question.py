...
class PreviewQuestion:
    def __init__(
        ...
        *,
        ...
        self.question = self.resolve_variants().get("question")
        ...
        self.descriptions = self.question.get("description")  # type: ignore
        self.guidance = self.question.get("guidance")  # type: ignore
